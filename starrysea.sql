...
CREATE TABLE `order` (
  ...
  `order_stauts` tinyint(4) NOT NULL COMMENT '1-未发货\r\n2-已发货',
  PRIMARY KEY (`order_id`),
  KEY `order_area` (`order_area`),
  CONSTRAINT `order_ibfk_1` FOREIGN KEY (`order_area`) REFERENCES `area` (`area_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
